          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li class="dropdown-submenu">
                      <a class="dropdown-item dropdown-toggle" href="#" id="dropdownShopMen" data-bs-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">Shop for Men</a>
                      <ul class="dropdown-menu" aria-labelledby="dropdownShopMen">
                        <li>
                          <a href="page/man/shorts.php" class="dropdown-item item-anchor">Shorts</a>
                        </li>
                        <li>
                          <a href="page/man/trousers.php" class="dropdown-item item-anchor">Trousers</a>
                        </li>
                        <li>
                          <a href="page/man/shirts.php" class="dropdown-item item-anchor">Shirts</a>
                        </li>
                        <li>
                          <a href="page/man/t-shirts.php" class="dropdown-item item-anchor">T-Shirts</a>
                        </li>
                      </ul>
                    </li>
                    <li class="dropdown-submenu">
                      <a class="dropdown-item dropdown-toggle" href="#" id="dropdownShopWomen" data-bs-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">Shop for Women</a>
                      <ul class="dropdown-menu" aria-labelledby="dropdownShopWomen">
                        <li>
                          <a href="page/woman/tops.php" class="dropdown-item item-anchor"> Tops </a>
                        </li>
                        <li>
                          <a href="page/woman/dresses.php" class="dropdown-item item-anchor"> Dresses </a>
                        </li>
                        <li>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="page/onsale/onsale.php" id="OnSale">On Sale</a>
                </li>
                <li class="nav-item dropdown">

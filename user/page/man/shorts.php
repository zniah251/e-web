...
<?php include('../../../navbar.php'); ?>
  <div class="container my-5">
    <h2 class="text-center mb-4">Quần Shorts Nam</h2>
    <!-- Sorting UI -->
    ...
    <div class="row g-4" id="product-list">
      <?php
      include("../../../connect.php");
      $sql = "SELECT * FROM product WHERE (cid = 7 OR cid = 8) AND title LIKE '%short%' AND size = 'L' ORDER BY price ASC";
